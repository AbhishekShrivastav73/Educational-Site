...
const Login = () => {
  ...
  return (
    <>
    <div className='flex bg-zinc-50 items-center justify-center'>

  
    <div className='w-full md:w-1/3 h-screen flex flex-col justify-center px-5 bg-zinc-50 text-black' >
        ...
        <div className='w-full border  border-zinc-500 mt-6 relative'>
            <h6 className='absolute -top-4 bg-zinc-50 px-2 left-1/2 -translate-x-[50%] text-center'>or continue with email</h6>
        </div>
        <form className='mt-6 flex flex-col gap-2 ' onSubmit={handleSubmit(data => {
            navigate('/home')
        })}>
            <div className='w-full h-12 bg-zinc-200 relative flex items-center overfloe-hidden rounded-md'>
                <span className='px-2'>
                    < CiMail/>
                    </span>
